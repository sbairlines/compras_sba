				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Edición de Usuarios
							</div>
						</div>
						<?php
						...
						<div class="portlet-body form">
							<form class="form-horizontal" action="lib/usuarios.php?t=edit&id=<?=$_GET["id"];?>" method="post" role="form">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Nombre</label>
										<div class="col-md-9">
											<input type="text" name="txtNombre" value="<?=$data["nombre"]?>" class="form-control" placeholder="Nombre">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Apellido</label>
										<div class="col-md-9">
											<input type="text" name="txtApellido" value="<?=$data["apellido"]?>" class="form-control" placeholder="Apellido">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Usuario</label>
										<div class="col-md-9">
											<input type="text" name="txtUsuario" value="<?=$data["usuario"]?>" class="form-control" placeholder="Usuario">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Clave</label>
										<div class="col-md-9">
											<input type="password" name="txtClave" value="<?=$data["clave"]?>" class="form-control" placeholder="Clave">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Confirmar Clave</label>
										<div class="col-md-9">
											<input type="password" name="txtClaveRe" value="<?=$data["clave"]?>" class="form-control" placeholder="Confirmar Clave">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<select name="cboTipo">
												<option <?=($data["tipo"] == 0)?"selected":""?> value="0">Usuario Interno</option>
												<option <?=($data["tipo"] == 1)?"selected":""?> value="1">Proveedor</option>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<select name="cboProveedor">
												...
												?>
												<option <?=($data["id_proveedor"] == $datos["id"])?"selected":""?> value="<?=$datos["id"]?>"><?=$datos["razon_social"]?></option>
												<?php
												}
												?>
											</select>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<?php				
											$priv = $db->select("usuario_privilegio", "id_privilegio", ["id_usuario" => $_GET["id"]]);							
