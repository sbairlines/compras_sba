...
<!-- Mirrored from www.keenthemes.com/preview/conquer/table_advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Jul 2014 18:20:51 GMT -->
				...
				<div class="theme-options">
					...
					<div class="theme-option">
						...
						<select class="layout-option form-control input-small">
							...
							<option value="boxed">Encajonado</option>
						</select>
					</div>
					<div class="theme-option">
						<span>
							...
							<form class="form-horizontal" role="form">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" placeholder="Ej: Productos de Limpieza">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" placeholder="Ej: 10-07-2014">
											<span class="help-block">
												 texto de ayuda.
											</span>
										</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" placeholder="Ej: 30-07-2014">
											<span class="help-block">
												 texto de ayuda.
											</span>
										</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" placeholder="Ejm: Juan Perez">
											<span class="help-block">
												 texto de ayuda.
											</span>
										</div>
