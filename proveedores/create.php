				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Nuevo Proveedor
							</div>
						</div>
						<div class="portlet-body form">
							<form class="form-horizontal" action="lib/proveedores.php?t=create" method="post" role="form">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Código</label>
										<div class="col-md-9">
											<input type="text" name="txtCodigo" class="form-control" placeholder="Codigo Interno de proveedor">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="txtRif" class="form-control" placeholder="Rif">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea name="txtDireccion" class="form-control" placeholder="Dirección"></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Ciudad</label>
										<div class="col-md-9">
											<input type="text" name="txtCiudad" class="form-control" placeholder="Ciudad">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">País</label>
										<div class="col-md-9">
											<input type="text" name="txtPais" class="form-control" placeholder="País Ejemplo: VE">
										</div>
									</div>
									<div class="form-group">
